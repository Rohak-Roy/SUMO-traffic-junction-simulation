...
import numpy as np
from classes_and_methods import displayCumulative, percentChange, displayCumulative_all_three
...
# df_after_ML['Number of Vehicles Stopped'].plot()
# plt.ylabel('Number of Vehicles Stopped - After')
# plt.xlabel('Seconds Elapsed')
...
# figure.add_subplot(1, 3, 3)
# df_after_ML['Total Waiting Time of All Vehicles'].plot()
# plt.ylabel('Total Waiting Time of All Vehicles (s) - After')
# plt.xlabel('Seconds Elapsed')
...
displayCumulative_all_three(df_before['Total Waiting Time of All Vehicles'], df_after['Total Waiting Time of All Vehicles'], df_after_ML['Total Waiting Time of All Vehicles'], title='Cumulative Total Waiting Time of All Vehicles')
